...
# open output files
fo_gl_core_h = open(path + "/gen/gl_loader_core.h","w")
fo_gl_core_cpp = open(path + "/gen/gl_loader_core.cpp","w")
fo_gl_compat_h = open(path + "/gen/gl_loader_compat.h","w")
fo_gl_compat_cpp = open(path + "/gen/gl_loader_compat.cpp","w")
